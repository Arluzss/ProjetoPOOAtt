...
public class ContaInvestimento implements Serializable, IConta {
    ...
    public String toString() {
        return "Conta Investimento [numero=" + numero + ", saldo=" + saldo + ", dataAbertura=" + dataAbertura
                + ", status=" + status
                + "]";
    }
    ...
    public void transferir(float quantia, IConta contaDestino) {
        try {
            ContaInvestimento contaTempDestino = (ContaInvestimento) contaDestino;
